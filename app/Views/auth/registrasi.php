        ...
        <div class="card">
            <div class="card-body register-card-body">
                ...
                <form action="/registrasiProses" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <textarea name="desc_profile" id="desc_profile" class="form-control <?= (session('validation') && session('validation')->hasError('desc_profile')) ? 'is-invalid' : ''; ?>" id="desc_profile" name="desc_profile" placeholder="Deskripsi Profile" cols="30" rows="4" value="<?= old('desc_profile'); ?>"></textarea>
