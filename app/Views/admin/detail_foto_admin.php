                                        ...
                                        <div class="card card-widget" style="background-color: #343A40;">
                                            <div class="card-header">
                                                <div class="user-block">
                                                    ...
                                                    <span class="username"><a href="/admin/profileUser">Jonathan Burke Jr.</a></span>
                                                    <span class="description">Shared publicly - 7:30 PM Today</span>
                                                </div>

                                                <div class="card-tools">
                                                    <button type="button" class="btn btn-danger" title="Hapus Foto">
                                            ...
                                            <div class="card-body">
                                                <img class="img-fluid pad" src="<?php echo base_url('assets') ?>/img/gallery/gallery-4.jpg" alt="Photo">
                                                <p class="deskripsi-detail">I took this photo this morning. What do you guys think?</p>
                                            ...
                                            <div class="comment-output">
                                                ...
                                                <div class="detail-comment">
                                                    ...
                                                    <div class="isi-comment">
                                                        This is a wider card with supporting text below as a natural lead-in to additional content.This is a wider card with supporting text below as a natural lead-in to additional content.This is a wider card with supporting text below as a natural lead-in to additional content.This is a wider card with supporting text below as a natural lead-in to additional content.This is a wider card with supporting text below as a natural lead-in to additional content.This is a wider card with supporting text below as a natural lead-in to additional content.This is a wider card with supporting text below as a natural lead-in to additional content.This is a wider card with supporting text below as a natural lead-in to additional content.This is a wider card with supporting text below as a natural lead-in to additional content.
                                                    </div>
                                                </div>
